...
<div className="w-full flex items-center justify-center bg-black">
        <div className="md:w-[90%] w-full px-4 text-white flex flex-col">
            <div className="w-full text-4xl sm:text-5xl md:text-7xl font-bold pt-10">
                <h1 className="w-full md:w-[90%] pt-10">
                <span className='capitalize text-slate-300'>Stock Graph </span></h1>
            </div>
            <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                <p className="w-full md:w-2/4 text-gray-400">Platform for stock graph, trends and Insights.
                <br /> <br />
                Stay ahead of the market with dynamic, live-updating stock graphs. Analyze trends, make decisions, and stay informed!</p>
            ...
            <div className="flex flex-col">
                <div className="flex mt-12 mb-6 px-[15px] md:px-1 flex-row items-center justify-between">
                    <div className="">
              ...
              />
                    ...
                    <a href="/" className="hidden md:block cursor-pointer text-gray-400 hover:text-[#F97315] uppercase">Home</a>
                    <a onClick={handleGetStartedClick} className="hidden md:block cursor-pointer text-gray-400 hover:text-[#F97315] uppercase">Try it out!</a>
                    <a href='https://github.com/ayushflows/Alloan.ai-Stock-Graph-Assesment' target='blank' className="hidden md:block cursor-pointer text-gray-400 hover:text-[#F97315] uppercase">Github</a>
                    <a href="https://www.linkedin.com/in/ayushflows" target="blank" className="hidden md:block cursor-pointer text-gray-400 hover:text-[#F97315] uppercase">Contact</a>
                ...
                <p className="w-full text-center my-6 text-gray-600">Copyright © 2024 Team LogiX</p>
            </div>
        </div>
    </div>
  )
